...
internal class Patch_GuiDialogEditWayPoint_onSave
{
    public static readonly MethodInfo ToReplaceWithMethod = AccessTools.Method(typeof(Patch_GuiDialogEditWayPoint_onSave), nameof(BroadcastWayPoint));
